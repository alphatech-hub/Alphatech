...
export default function Hero({
  headline1 = "Technology that works.",
  headline2 = "Engineered to last.",
  subheadline = "From a cracked laptop screen to a full office network — our engineers diagnose fast, repair it right, and back every job with a warranty.",
  ctaPrimary = "Book a Repair",
  ctaSecondary = "Shop Computers",
}: Props) {
  return (
    <section className="relative bg-slate-950 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-5 lg:px-8 py-20 lg:py-28 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="font-body text-slate-400 text-lg mt-6 max-w-lg">{subheadline}</p>
